    ...
    <div class="main-content">
        ...
        <section  class="overview-block-ptb grey-bg iq-price-table">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="heading-title" style="margin-bottom: -10px;">
                            ...
                            <h3 class="title iq-tw-7" id="pricing">Inversión</h3>
				...
				<div style="border: 1px solid #CCC; background-color: white; padding: 10px; margin-top: 20px;">

					<table width="100%">

						<tr style="font-weight: bold; background-color: #337ab7; color: white; height: 50px; font-size:20px;">

							<td>INCLUYE</td>

                            <td>PLAN INICIAL<br>$1.200.000/AÑO</td>

                            <td>PLAN PROFESIONAL<br>$2.400.000/AÑO</td>

                            <td>PLAN AVANZADO<br>$3.000.000/AÑO</td>
						...
						<tr style="height: 20px;">
							...
							<td>Directivos</td><td>5</td><td>10</td><td>Ilimitados</td>

						</tr>

						<tr style="height: 20px;">

							<td>Docentes</td><td>10</td><td>30</td><td>Ilimitados</td>

						</tr>

						<tr style="height: 20px;">

							<td>Estudiantes</td><td>200</td><td>1.000</td><td>Ilimitados</td>

						</tr>

						

						<tr style="background-color: #fbbd01; font-weight: bold;">

							<td colspan="4">MÓDULOS GENERALES</td>

						</tr>

						<tr>

							<td>Módulo Académico</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Módulo Comunicativo</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Módulo Financiero</td><td>-</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Módulo Disciplinario</td><td>-</td><td>-</td><td>SI</td>

						</tr>

						<tr>

							<td>Módulo Mercadeo</td><td>-</td><td>-</td><td>SI</td>
						...
						<tr style="background-color: #fbbd01; font-weight: bold;">
							...
							<td colspan="4">EDUCACIÓN VIRTUAL</td>

						</tr>

						<tr>

							<td>Clases mediante videos</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Tareas/Actividades para la casa</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Foros de discusión</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Carpetas compartidas</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Chat institucional</td><td>-</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Exámenes en línea</td><td>-</td><td>SI</td><td>SI</td>
						...
						<tr style="background-color: #fbbd01; font-weight: bold;">
							...
							<td colspan="4">COMPLEMENTARIOS</td>

						</tr>

						<tr>

							<td>Capacitación virtual</td><td>2 HORAS</td><td>2 HORAS</td><td>2 HORAS</td>

						</tr>

						<tr>

							<td>Manual en línea</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Tutorial por pantalla</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Garantía</td><td>Siempre</td><td>Siempre</td><td>Siempre</td>

						</tr>

						<tr>

							<td>Almacenamiento</td><td>10 GB</td><td>25 GB</td><td>50 GB</td>
						...
						<tr style="background-color: #fbbd01; font-weight: bold;">
							...
							<td colspan="4">SOPORTE Y ASISTENCIA</td>

						</tr>

						<tr>

							<td>Soporte por correo</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Soporte por chat web</td><td>SI</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Soporte por whatsapp</td><td>-</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Soporte por teléfono</td><td>-</td><td>-</td><td>SI</td>

						</tr>

						<tr>

							<td>Horario de atención</td><td>Normal</td><td>Normal</td><td>Extendido</td>
						...
						<tr>
							...
							<td>Respaldo de datos</td><td>Mensual</td><td>Semanal</td><td>Diario</td>

						</tr>

						<tr>

							<td>Importación inicial</td><td>Cotización</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Personalización boletín</td><td>Cotización</td><td>SI</td><td>SI</td>

						</tr>

						<tr>

							<td>Desarrollos adicionales</td><td>Cotización</td><td>Cotización</td><td>Cotización</td>
						...
						<tr>
							...
							<td><a class="button" href="prueba-gratis.php?p=1">PRUEBA GRATIS</a></td>

							<td><a class="button" href="prueba-gratis.php?p=2">PRUEBA GRATIS</a></td>

							<td><a class="button" href="prueba-gratis.php?p=3" style="background-color: purple;">PRUEBA GRATIS</a></td>
